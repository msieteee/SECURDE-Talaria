			...
			<div class = "col-lg-offset-1 row col-lg-6">
				<div class="row">
					...
					<form id="Register" action="Register" method="POST" name="Register">
						<div class = "row">
							<input type="text" name="name" class="text-fld col-lg-8 col-lg-offset-2" placeholder="Full Name">
						</div>
						<div class = "row">
						...
						<div class = "row">
							<input type="password" name="cpass" class="pass-fld col-lg-8 col-lg-offset-2" placeholder="Confirm Password">
						</div>
						...
						<div class = "row">
							<input type="text" name="bahouseno" class="text-fld col-lg-3" placeholder="House #">
							<input type="text" name="bastreet" class="text-fld col-lg-3" placeholder="Street">
							<input type="text" name="basubd" class="text-fld col-lg-3" placeholder="Subdivision">
							<input type="text" name="bacity" class="text-fld col-lg-3" placeholder="City">
						</div>
						<div class = "row">
							<input type="text" name="bapostal" class="text-fld col-lg-3 col-lg-offset-3" placeholder="Postal">
							<input type="text" name="bacountry" class="text-fld col-lg-3" placeholder="Country">
						</div>
						...
						<div class = "row">
							<input type="text" name="sahouseno" class="text-fld col-lg-3" placeholder="House #">
							<input type="text" name="sastreet" class="text-fld col-lg-3" placeholder="Street">
							<input type="text" name="sasubd" class="text-fld col-lg-3" placeholder="Subdivision">
							<input type="text" name="sacity" class="text-fld col-lg-3" placeholder="City">
						</div>
						<div class = "row">
							<input type="text" name="sapostal" class="text-fld col-lg-3 col-lg-offset-3" placeholder="Postal">
							<input type="text" name="sacountry" class="text-fld col-lg-3" placeholder="Country">
						</div>
						<div class = "row">
						<br>
	  	...
	  	<div class="modal-dialog">
			<div class="loginmodal-container">
				<h1 class = "to-white"><b>TALARIA</b></h1><br>
			  	...
			  	<form id="login-form" action="Authentication" method="POST" name="Authentication">

...
<html lang="en">
  <head>
    ...
    <link href="assets/css/accountingpage.css" rel="stylesheet">
  ...
  <body data-spy="scroll" data-offset="0">
	...
	<div id="w2">
		...
		<form>
			<div class="container">
				<div class = "row">
					<button class="product-cat-btn">All</button> -
					<button class="product-cat-btn">BOOTS</button> - 
					<button class="product-cat-btn">SHOES</button> - 
					<button class="product-cat-btn">SANDALS</button> - 
					<button class="product-cat-btn">SLIPPERS</button>
				</div>
				</br>
				<div class = "row">
					<div class = "col-lg-8 col-lg-offset-2">
						<div class = "row">
							<table class="table">
								<thead>
									<tr>
										<th class="th-custom">Item Name</th>
										<th class="th-custom">Unit Price</th>
										<th class="th-custom">Qty. Sold</th>
										<th class="th-custom">Total Price</th>
									</tr>
								</thead>
								<tbody>
								<c:forEach items="${transactionReport}" var="tr" varStatus="loop">
									<tr>
									...
									<!-- INSERT OTHER ITEMS -->
									<tr>
									<c:set var="total" value="${total}" scope="request"></c:set>

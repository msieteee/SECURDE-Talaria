...
<html lang="en">
  ...
  <body data-spy="scroll" data-offset="0">
	...
	<div id="w2">
		...
		<div class="container">
			<div class = "row">
				<div class = "col-lg-6 col-lg-offset-3 product-details">
					<form method="POST" action="Validation">
						<div class = "row">
							<h6 class="text-space col-lg-offset-1"><b>New Password</b></h6>
							<input type="password" name="newpass" class="text-fld col-lg-10 col-lg-offset-1" >
						</div>
						<div class = "row">
							<h6 class="text-space col-lg-offset-1"><b>Confirm Password</b></h6>
							<input type="password" name="cpass" class="text-fld col-lg-10 col-lg-offset-1">
						</div>
						<div class = "row">
							<center><input type="submit" name="login" class="btn btn-lg transact-btn" value="CONFIRM"></center>
						</div>
					</form>
				</div>
			</div>

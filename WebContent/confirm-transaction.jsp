		...
		<form method="POST" action="ConfirmTransaction">
			...
			<div class="container">
				<div class = "row">
					<div class = "col-lg-4 col-lg-offset-1">
						<div class = "row">
							<table class="table">
								<thead>
									<tr>
										<th class="th-custom">Qty.</th>
										<th class="th-custom">Name</th>
										<th class="th-custom">Unit Price</th>
									</tr>
								</thead>
								<tbody>
								<c:set var="p" value="${product}" scope="request"></c:set>
								<c:set var="q" value="${quantity}" scope="request"></c:set>
									<tr>
										<td>${q}</td>
										<td>${p.name}</td>
										<td>${p.price}</td>
					...
					<div class = "col-lg-5 col-lg-offset-1 product-details vcenter">					
						<div class = "row">
						<c:set var="n" value="${name}" scope="request"></c:set>
							<h6 class="text-space"><b>Full Name</b></h6>
							<input type="text" name="shipadd" disabled="true" class="text-fld col-lg-10 disabled" value="${n}">
						</div>
						<div class = "row">
						...
						<div class = "row">
						<c:set var="c" value="${maskedCredit}" scope="request"></c:set>
							<h6 class="text-space"><b>Credit Card No.</b></h6>
							<input type="text" name="shipadd" disabled="true" class="text-fld col-lg-10 disabled" value="${c}">
						</div>
						<div class = "row">
							<h6 class="text-space"><b>Password</b></h6>
							<input type="password" name="pass" class="text-fld col-lg-10 disabled" placeholder="Enter Password">
						</div>
					</div>
				</div>
				<div class = "row">

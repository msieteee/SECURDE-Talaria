...
<html lang="en">
  ...
  <body data-spy="scroll" data-offset="0">
	...
	<div class="modal fade modal-custom in" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
	  	<div class="modal-dialog">
			<div class="loginmodal-container">
				<h1 class = "to-white"><b>TALARIA</b></h1>
			  	<h5 class = "error-text text-center">Account temporarily blocked after too many unsuccessful attempts</h5>

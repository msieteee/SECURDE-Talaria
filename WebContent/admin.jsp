			...
			<div class = "row">
				<div class = "col-lg-5 col-lg-offset-1">
					<div class = "row">
						...
						<form id="prodmanager-form" action="AddProductManager" method="POST" name="AddProductManager">
				...
				<div class = "col-lg-5">					
					<div class = "row">
						...
						<form id="acntmanager-form" action="AddAccountManager" method="POST" name="AddAccountManager">
							<input type="hidden" name="csrfPreventionSalt" value="${csrfPreventionSalt}"/>
							<div class = "row">
								<input type="text" name="user" class="text-fld col-lg-8 col-lg-offset-2" placeholder="Username">
							</div>

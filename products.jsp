		...
		<div class="container">
			...
			<section id="pinBoot">
				<c:forEach items="${products}" var="p" varStatus="loop">
					<article class="white-panel"><img class="pin-image" src="" alt="">
						<h5><a class="panel-link" href="Product" onclick="getCategoryIndex(${loop.index})"><b>${p.name}<br>${p.price}</b></a></h5>
					</article>
				</c:forEach>
